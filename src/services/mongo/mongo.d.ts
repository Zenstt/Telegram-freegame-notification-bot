 ...
 */
export declare function Collection(collectionName: string): Promise<mongodb.Collection<any>>;
/**
 ...
 */
export declare function Find(collectionName: string, query: mongodb.FilterQuery<any>, projection?: object, sort?: string | object, limit?: number | boolean, skip?: number): Promise<any>;
/**
 ...
 */
export declare function Distinct(collectionName: string, field: string, query: mongodb.FilterQuery<any>, options: Object): Promise<any[]>;
/**
 ...
 * @param {boolean|number} limit specifies the number of documents to retrieve, true means 1
 */
export declare function FindCursor(collectionName: string, query: mongodb.FilterQuery<any>, projection?: object, sort?: string | object, limit?: number | boolean, skip?: number): Promise<mongodb.Cursor<any>>;
/**
 ...
 */
export declare function InsertOne(collectionName: string, document: any, options?: mongodb.CollectionInsertOneOptions): Promise<mongodb.InsertOneWriteOpResult<any>>;
/**
 ...
 */
export declare function InsertMany(collectionName: string, documents: any[], options?: mongodb.CollectionInsertManyOptions): Promise<mongodb.InsertWriteOpResult<any>>;
/**
 ...
 */
export declare function DeleteOne(collectionName: string, query: mongodb.FilterQuery<any>, options?: mongodb.CommonOptions): Promise<mongodb.DeleteWriteOpResultObject>;
/**
 ...
 * @param {CommonOptions} [options] Options for the delete
 */
export declare function DeleteMany(collectionName: string, query: mongodb.FilterQuery<any>, options?: mongodb.CommonOptions): Promise<mongodb.DeleteWriteOpResultObject>;
/**
 *
 ...
 */
export declare function UpdateOne(collectionName: string, query: mongodb.FilterQuery<any>, update: mongodb.UpdateQuery<any> | Partial<any>, options?: mongodb.UpdateOneOptions): Promise<mongodb.UpdateWriteOpResult>;
/**
 ...
 */
export declare function UpdateMany(collectionName: string, query: mongodb.FilterQuery<any>, update: mongodb.UpdateQuery<any> | Partial<any>, options?: mongodb.UpdateManyOptions): Promise<mongodb.UpdateWriteOpResult>;
/**
 ...
 * @param {boolean|number} limit specifies the number of documents to retrieve, true means 1
 */
export declare function Count(collectionName: string, query: mongodb.FilterQuery<any>, limit?: number | boolean): Promise<number>;
/**
 ...
 */
export declare function Aggregate(collectionName: string, query_aggregate: object[], options?: mongodb.CollectionAggregationOptions): Promise<any[]>;
/**
 ...
 * @param {CollectionAggregationOptions} [options] Options for the update
 */
export declare function Aggregate_cursor(collectionName: string, query_aggregate: object[], options?: mongodb.CollectionAggregationOptions): Promise<mongodb.AggregationCursor<any>>;
/**
* Create a index on a collection
* @param {string} collectionName The collection to access
* @param {IndexOptions} indexData Data of index to create
*/
export declare function CreateIndex(collectionName: string, indexData?: mongodb.IndexOptions): Promise<string>;
/**
* Returns the stats of a collection
* @param {string} collectionName The collection to access
*/
export declare function Stats(collectionName: string): Promise<mongodb.CollStats>;
