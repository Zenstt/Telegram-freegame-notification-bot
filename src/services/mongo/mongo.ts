...
let DB: mongodb.Db;
let clientDB: mongodb.MongoClient;

/**
 * Connects to the database, must be called to do any db operation
 * @param {any} conf 
 */
export async function Connect(conf: any = config.mongo_connection) {
    if (DB) return;
    conf = conf;
 ...
 */
export async function Find(collectionName: string, query: mongodb.FilterQuery<any>, projection: object = {}, sort: string | object = {}, limit: number | boolean = false, skip: number = 0) {
 ...
 */
export async function Distinct(collectionName: string, field: string, query: mongodb.FilterQuery<any>, options: Object) {
 ...
 * @param {boolean|number} limit specifies the number of documents to retrieve, true means 1
 */
export async function FindCursor(collectionName: string, query: mongodb.FilterQuery<any>, projection: object = {}, sort: string | object = {}, limit: number | boolean = false, skip: number = 0) {
    const collection = await Collection(collectionName);
 ...
 */
export async function InsertOne(collectionName: string, document: any, options: mongodb.CollectionInsertOneOptions = {}) {
    if (!options) { options = {}; }
    const collection = await Collection(collectionName);
 ...
 */
export async function InsertMany(collectionName: string, documents: any[], options: mongodb.CollectionInsertManyOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 */
export async function DeleteOne(collectionName: string, query: mongodb.FilterQuery<any>, options: mongodb.CommonOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 * @param {CommonOptions} [options] Options for the delete
 */
export async function DeleteMany(collectionName: string, query: mongodb.FilterQuery<any>, options: mongodb.CommonOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 */
export async function UpdateOne(collectionName: string, query: mongodb.FilterQuery<any>, update: mongodb.UpdateQuery<any> | Partial<any>, options: mongodb.UpdateOneOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 */
export async function UpdateMany(collectionName: string, query: mongodb.FilterQuery<any>, update: mongodb.UpdateQuery<any> | Partial<any>, options: mongodb.UpdateManyOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 * @param {boolean|number} limit specifies the number of documents to retrieve, true means 1
 */
export async function Count(collectionName: string, query: mongodb.FilterQuery<any>, limit: number | boolean = false) {
 ...
 */
export async function Aggregate(collectionName: string, query_aggregate: object[], options: mongodb.CollectionAggregationOptions = {}) {
    const collection = await Collection(collectionName);
 ...
 * @param {CollectionAggregationOptions} [options] Options for the update
 */
export async function Aggregate_cursor(collectionName: string, query_aggregate: object[], options: mongodb.CollectionAggregationOptions = {}) {
    const collection = await Collection(collectionName);
...
*/
export async function CreateIndex(collectionName: string, indexData: mongodb.IndexOptions = {}) {
    const collection = await Collection(collectionName);
